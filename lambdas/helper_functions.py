...
device_trail_log_hour_table = dynamodb.Table(os.environ.get("DEVICE_TRAIL_LOG_HOUR_TABLE", "local_traillcount_device_trail_hour_table"))
device_trail_log_day_table = dynamodb.Table(os.environ.get("DEVICE_TRAIL_LOG_DAY_TABLE", "local_traillcount_device_trail_day_table"))
device_trail_log_week_table = dynamodb.Table(os.environ.get("DEVICE_TRAIL_LOG_WEEK_TABLE", "local_traillcount_device_trail_week_table"))
device_trail_log_month_table = dynamodb.Table(os.environ.get("DEVICE_TRAIL_LOG_MONTH_TABLE", "local_traillcount_device_trail_month_table"))
...
area_table = dynamodb.Table(os.environ.get("AREA_TABLE", "local_traillcount_area_table"))
