...
class TrailDTO:
    def __init__(self, name: str, id: int=None, area_name: str="", notes: str="", latitude: float=0, longitude: float=0, date_activated: datetime=None, date_retired: datetime=None):
        self.name = name
        self.id = id
    ...
    def __str__(self):
        return f"TrailDTO [name={self.name}, id={self.id}, area_name={self.area_name}, notes={self.notes}, latitude={self.latitude}, longitude={self.longitude}, date_activated={self.date_activated}, date_retired={self.date_retired}]"
    ...
    def compare(self, other):
        ...
        if (self.area_name != "") and (other.area_name != ""):
            pytest_check.equal(self.area_name, other.area_name)
