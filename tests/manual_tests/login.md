...
| 2    | Type your email into the email field.                                                          | Text displays correctly without masking.                        | [x] Pass [ ] Fail |
| 3    | Enter valid password into the password input.                                                  | Characters display as masked dots (`•••••`) for privacy. | [x] Pass [ ] Fail |
| 4    | Click the Yellow**"Login"** button.                                                      | Redirected to the home page (`/home`).                        | [x] Pass [ ] Fail |
| 5    | Verify change in username on the top right in the navigation bar.                              | Username space displays: Username,**Role**                | [x] Pass [ ] Fail |
