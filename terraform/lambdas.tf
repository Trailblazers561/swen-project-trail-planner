...
resource "aws_lambda_function" "get_trail_data" {
  function_name = "${local.name_prefix}traildata_get_trail_data"
...
resource "aws_lambda_function" "upload_trail_data" {
  function_name = "${local.name_prefix}traildata_upload_trail_data"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "upload_device_data" {
  function_name = "${local.name_prefix}traildata_upload_device_data"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "update_trail_metadata" {
  function_name = "${local.name_prefix}traildata_update_trail_metadata"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "update_device_trail_association" {
  function_name = "${local.name_prefix}traildata_update_device_trail_association"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "get_trail_metadata" {
  function_name = "${local.name_prefix}traildata_get_trail_metadata"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "get_device_metadata" {
  function_name = "${local.name_prefix}traildata_get_device_metadata"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "get_trail_groups" {
  function_name = "${local.name_prefix}traildata_get_trail_groups"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "delete_trail" {
  function_name = "${local.name_prefix}traildata_delete_trail"
  role          = aws_iam_role.lambda_iam_role.arn
...
resource "aws_lambda_function" "create_trail" {
  function_name = "${local.name_prefix}traildata_create_trail"
  role          = aws_iam_role.lambda_iam_role.arn
